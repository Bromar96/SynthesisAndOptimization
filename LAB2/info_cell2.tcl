...
foreach_in_collection point_cell $ordered_collection {
   ...
   if { $cell_type == true } {
        puts "$cell_name is combinational, leakage power is $cell_leakage"
...
puts "Compare with computed chip area $chip_area\n\n"
#To compare chip power
report_power
puts "Compare with computed chip leakage power $chip_leakage"
puts "Compare with computed chip dynamic power $chip_dynamic"
